...
_GATHER_LOC_BUDGET = 5441  # +2 (2026-07-25): BL-F2 D-19 real fan-out fix -- _build_kusto_kpi_signal now populates Signal.workstream_ids from the full configured query.workstream_ids set; +3 (2026-07-25): BL-F2 M365 re-routing now explicitly replaces Signal.workstream_ids too, not just workstream_id; +11 (2026-07-15): ADF-W1.4 remainder -- overall WorkIQ phase wall-clock budget threading; +5 (2026-07-15): per-plan timeout_seconds=AgencyBridge.WORKIQ_TIMEOUT cap; +213 (2026-07-16, specs/armada.md): gather-run manifest lifecycle wrapper, discovery CLI flag threading, and gather_run_id stamping (D-13 rule 4); +36 (2026-07-21, specs/armada.md D-19/AG-2.12): completeness-oracle reconciliation (resolve_oracle_result wiring + --source-export CLI option)
