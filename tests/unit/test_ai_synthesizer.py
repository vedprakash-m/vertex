...
def test_workstream_synthesizer_parses_structured_json() -> None:
...
def test_workstream_synthesizer_rejects_invalid_json() -> None:
...
def test_workstream_synthesizer_rejects_invalid_proposed_risk() -> None:
    client = _FakeAIClient(
        json.dumps(
            {
                "overall_assessment": "Networking remains the gating lane until the servicing validation closes.",
...
def test_workstream_synthesizer_rejects_invalid_confidence() -> None:
    client = _FakeAIClient(
        json.dumps(
            {
                "overall_assessment": "Networking remains the gating lane until the servicing validation closes.",
...
def test_workstream_synthesizer_rejects_blank_evidence_ref_entry() -> None:
    client = _FakeAIClient(
        json.dumps(
            {
                "overall_assessment": "Networking remains the gating lane until the servicing validation closes.",
...
def test_workstream_synthesizer_rejects_unknown_evidence_ref() -> None:
    client = _FakeAIClient(
        json.dumps(
            {
                "overall_assessment": "Networking remains the gating lane until the servicing validation closes.",
...
def test_workstream_synthesizer_rejects_missing_required_list_fields() -> None:
...
def test_workstream_synthesizer_rejects_null_required_list_fields() -> None:
...
def test_workstream_synthesizer_includes_contradictions_in_prompt() -> None:
    client = _FakeAIClient(
        json.dumps(
            {
